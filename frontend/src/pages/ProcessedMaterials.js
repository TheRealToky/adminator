...
function MaterialsTab() {
    ...
    const columns = [
        ...
        { key: 'actions', header: '', align: 'right', render: (r) => (_jsxs("div", { className: "flex justify-end gap-1", children: [_jsx("button", { className: "btn-ghost p-1.5 text-emerald-700", title: t('processedMaterials.actions.produceBatch'), onClick: (e) => { e.stopPropagation(); setProduceFor(r); }, children: _jsx(PlayCircle, { size: 14 }) }), _jsx("button", { className: "btn-ghost p-1.5 text-brand-700", title: t('processedMaterials.actions.recipe'), onClick: (e) => { e.stopPropagation(); setRecipeFor(r); }, children: _jsx(Layers, { size: 14 }) }), _jsx("button", { className: "btn-ghost p-1.5 text-blue-700", title: t('processedMaterials.actions.usedInProducts'), onClick: (e) => { e.stopPropagation(); setUsageFor(r); }, children: _jsx(ChefHat, { size: 14 }) }), _jsx("button", { className: "btn-ghost p-1.5", title: t('processedMaterials.actions.adjustStock'), onClick: (e) => { e.stopPropagation(); setAdjustFor(r); }, children: _jsx(Sliders, { size: 14 }) }), _jsx("button", { className: "btn-ghost p-1.5", onClick: (e) => { e.stopPropagation(); openEdit(r); }, children: _jsx(Pencil, { size: 14 }) }), _jsx("button", { className: "btn-ghost p-1.5 text-red-600", onClick: (e) => { e.stopPropagation(); setToDelete(r); }, children: _jsx(Trash2, { size: 14 }) })] })) },
    ];
    const exportColumns = [
