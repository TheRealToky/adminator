    ...
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-brand-50 via-white to-amber-50 p-4">
      <div className="w-full max-w-md">
        <div className="text-center mb-8">
          ...
          <h1 className="text-2xl font-bold text-slate-900">Adminator</h1>
        ...
        <form onSubmit={onSubmit} className="card card-body space-y-4">
          ...
          >
            {submitting ? (<><Loader2 className="animate-spin mr-2" size={16} /> Signing in…</>) : 'Sign in'}
          </button>
          <p className="text-xs text-slate-500 text-center">
            Demo seed: admin@adminator.local / admin12345
          </p>
        </form>
      </div>
    </div>
